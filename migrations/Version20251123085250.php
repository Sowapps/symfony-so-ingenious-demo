 ...
 */
final class Version20251123085250 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('CREATE TABLE email_message (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, subscription_id INT NOT NULL, to_user_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, send_date DATETIME DEFAULT NULL, open_date DATETIME DEFAULT NULL, online_expire_date DATETIME DEFAULT NULL, private_key VARCHAR(32) NOT NULL, from_user_email VARCHAR(100) NOT NULL, from_user_name VARCHAR(50) NOT NULL, to_user_email VARCHAR(100) NOT NULL, to_user_name VARCHAR(50) DEFAULT NULL, subject VARCHAR(124) NOT NULL, body_html LONGTEXT DEFAULT NULL, body_text LONGTEXT DEFAULT NULL, purpose ENUM(\'user_registration\', \'user_recover\', \'contact\') NOT NULL COMMENT \'(DC2Type:enum_email_purpose)\', data JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', template_html VARCHAR(255) DEFAULT NULL, INDEX IDX_B7D58B085564492 (create_user_id), INDEX IDX_B7D58B09A1887DC (subscription_id), INDEX IDX_B7D58B029F6EE60 (to_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE email_subscription (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, disabled_message_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, private_key VARCHAR(32) DEFAULT NULL, purpose ENUM(\'user_registration\', \'user_recover\', \'contact\') NOT NULL COMMENT \'(DC2Type:enum_email_purpose)\', email VARCHAR(100) NOT NULL, disabled TINYINT(1) NOT NULL, disabled_date DATETIME DEFAULT NULL, INDEX IDX_F6D5828085564492 (create_user_id), UNIQUE INDEX UNIQ_F6D58280C88D811C (disabled_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, name VARCHAR(255) NOT NULL, extension VARCHAR(5) NOT NULL, mime_type VARCHAR(100) NOT NULL, purpose ENUM(\'user_avatar\') NOT NULL COMMENT \'(DC2Type:enum_file_purpose)\', private_key VARCHAR(32) NOT NULL, source_type ENUM(\'http_upload\', \'local\') NOT NULL COMMENT \'(DC2Type:enum_file_source)\', source_name VARCHAR(255) DEFAULT NULL, source_url VARCHAR(511) DEFAULT NULL, expire_date DATETIME DEFAULT NULL, parent_id INT DEFAULT NULL, position SMALLINT NOT NULL, storage ENUM(\'local\') NOT NULL COMMENT \'(DC2Type:enum_file_storage)\', path VARCHAR(255) DEFAULT NULL, output_name VARCHAR(255) DEFAULT NULL, INDEX IDX_8C9F361085564492 (create_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fragment (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, language_id INT NOT NULL, snippet_fragment_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, name VARCHAR(255) NOT NULL, properties JSON NOT NULL COMMENT \'(DC2Type:json)\', html LONGTEXT DEFAULT NULL, snippet TINYINT(1) NOT NULL, template_name VARCHAR(255) DEFAULT NULL, INDEX IDX_CBAD15EC85564492 (create_user_id), INDEX IDX_CBAD15EC82F1BAF4 (language_id), INDEX IDX_CBAD15EC3A2FD8F6 (snippet_fragment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE language (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, _key VARCHAR(255) NOT NULL, locale VARCHAR(7) NOT NULL, primary_code VARCHAR(7) NOT NULL, region_code VARCHAR(7) NOT NULL, enabled TINYINT(1) NOT NULL, INDEX IDX_D4DB71B585564492 (create_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, language_id INT NOT NULL, fragment_id INT NOT NULL, localized_unit_id INT NOT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, title VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, menu_name VARCHAR(255) DEFAULT NULL, INDEX IDX_140AB62085564492 (create_user_id), INDEX IDX_140AB62082F1BAF4 (language_id), INDEX IDX_140AB620596BD57E (fragment_id), INDEX IDX_140AB62038810B54 (localized_unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, create_user_id INT DEFAULT NULL, language_id INT NOT NULL, avatar_id INT DEFAULT NULL, create_date DATETIME NOT NULL COMMENT \'(DC2Type:datetimetz_immutable)\', create_ip VARCHAR(60) NOT NULL, version INT DEFAULT 1 NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, name VARCHAR(50) NOT NULL, activation_date DATETIME DEFAULT NULL, activation_expire_date DATETIME DEFAULT NULL, activation_key VARCHAR(32) DEFAULT NULL, recover_request_date DATETIME DEFAULT NULL, recovery_key VARCHAR(32) DEFAULT NULL, disabled TINYINT(1) NOT NULL, timezone VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64985564492 (create_user_id), INDEX IDX_8D93D64982F1BAF4 (language_id), UNIQUE INDEX UNIQ_8D93D64986383B10 (avatar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
